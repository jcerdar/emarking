...
$string['emarking:grade'] = 'Grade exams';
$string['emarking:manageanonymousmarking'] = 'Manage anonymous marking';
$string['emarking:managedelphiprocess'] = 'Manage markers collaboration';
$string['emarking:manageprinters'] = 'Manage printers';
$string['emarking:managespecificmarks'] = 'Manage specific marks';
...
$string['emarking:regrade'] = 'Regrade exams';
$string['emarking:submit'] = 'Submit exams';
$string['emarking:supervisegrading'] = 'Supervise grading';
$string['emarking:uploadexam'] = 'Upload an exam';
$string['emarking:view'] = 'View activity';
...
$string['emarking:viewcourses'] = 'View courses in category';
$string['emarking:markingincategory'] = 'Marking in category';
// NOTIFICATIONS.
...
$string ['bottomqr'] = 'Include QR at the bottom of the page';
$string ['bottomqr_help'] = 'Include an extra QR at the bottom of the page for extra possibilities on identifying the code.';
...
$string ['nostudent'] = 'There are no enrolled students.';
...
$string['emarkingnamestrong'] = '<strong>Emarking Name</strong>';
$string['dayssenttoprint'] = 'sent to print(Days)';
$string['printeddays'] = 'Printed(Days)';
$string['digitalizeddays'] = 'Digitalized(Days)';
$string['daysincorrection'] = 'Grading(Days)';
$string['gradeddays'] = 'Gradeded(Days)';
$string['publisheddays'] = 'Published(Days)';
$string['daysinregrading'] = 'Regrading(Days)';
$string['regradeddays'] = 'Regradeded(Days)';
$string['finalpublicationdays'] = 'Final publication(Days)';
$string['senttoprint'] = 'Sent to print';
$string['printed'] = 'Printed';
$string['digitalized'] = 'Digitalized';
$string['incorrection'] = 'Grading';
$string['graded'] = 'Gradeded';
$string['published'] = 'Published';
$string['inregrading'] = 'Regrading';
$string['regraded'] = 'Regradeded';
$string ['regradepending'] = 'Regrade pending';
$string ['markpending'] = 'Mark pending';
$string['finalpublication'] = 'Final publication';
$string['ganttprint'] = 'Print';
$string['ganttdigitization'] = 'Digitalization';
$string['ganttcorrection'] = 'Correction';
$string['ganttpublication'] = 'Publication';
$string['ganttrecorrection'] = 'Regrade';
$string['total'] = 'total';
$string['totaldays'] = 'Total(Days)';
$string['searchcourses'] = 'Search Courses';
$string['search'] = 'Search';
$string['justice_perception'] = 'Justice Perception';
$string['cicletabledays'] = 'Day(s)';
$string['cicletablehours'] = 'Hour(s)';
$string['ciclechartalert'] = 'If a status is not showing on the chart  maybe it took less than 24hours, please go to the first table below the chart for more specific information';
$string['cicletable'] = 'Cicle summary table';
$string['ciclechart'] = 'Cicle summary chart';
$string['justiceperceptiontable'] = 'Justice perception table';
$string['cicletablealert'] = 'If there is a diference between total time and the summatory of all sections remember that the hours could include minutes that are not shown';
$string['cicleganttchart'] = 'Gantt cicle of the EMarking';
$string['ciclestackedstatuses'] = 'Tests status cicle';
...
$string['choosevalue'] = 'Choose a value';
$string['optionalcomment'] = 'Optional comment';
$string['updateevaluate'] = 'The answers were successfully updated.';
$string['createevaluate'] = 'The answers were successfully saved.';
$string['formevaluatedfeedback'] = 'Form for the evaluation of the feedback';
$string['value'] = 'Value';
$string['indicator'] = 'Indicator';
$string['countofmarkers'] = 'Quantity of markers';
$string['timeincorrection'] = 'Total correction time';
$string['timestudentview'] = 'Total student review time';
$string['criteriontoevaluate'] = 'Criteria for evaluating the generated feedback by the marker';
$string['evaluation'] = 'Evaluation';
$string['complexitycriterion'] = 'Complexity, it is possible to understand the messages delivered by the marker.';
$string['relevantcriterion'] = 'The marker provides information about the expected result. Indicates, explicitly or indirectly, the gap between the expected result and the one answered by the student.';
$string['personalizationcriterion'] = 'The messages delivered by the marker are personalized, so that their compression is friendly.';
