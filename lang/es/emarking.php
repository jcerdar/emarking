...
$string['emarking:downloadexam'] = 'Download exam';
$string['emarking:grade'] = 'Corregir pruebas';
$string['emarking:manageanonymousmarking'] = 'Administrar anonimato';
$string['emarking:managedelphiprocess'] = 'Administrar colaboración entre correctores';
...
$string['emarking:receivedigitizingnotification'] = 'Receive notification for digitizing';
$string['emarking:receivenotification'] = 'Receive notification for printing';
$string['emarking:regrade'] = 'Recorregir pruebas';
$string['emarking:submit'] = 'Entregar pruebas';
$string['emarking:supervisegrading'] = 'Supervisar corrección';
$string['emarking:uploadexam'] = 'Subir respuestas';
$string['emarking:view'] = 'Ver actividad';
...
$string ['bottomqr'] = 'Incluir QR al fondo de la página';
$string ['bottomqr_help'] = 'Incluir un código QR al fondo de la página para aumentar las posiblidades de identificación.';
...
$string['dayssenttoprint'] = 'enviado a imprimir(Días)';
$string['printeddays'] = 'Impreso(Días)';
$string['digitalizeddays'] = 'Digitalizado(Días)';
$string['daysincorrection'] = 'En corrección(Días)';
$string['gradeddays'] = 'Corregido(Días)';
$string['publisheddays'] = 'Publicado(Días)';
$string['daysinregrading'] = 'En recorrección(Días)';
$string['regradeddays'] = 'Recorregido(Días)';
$string['finalpublicationdays'] = 'Publicación final(Días)';
$string['totaldays'] = 'Total(Días)';
$string['senttoprint'] = 'Enviado a imprimir';
$string['printed'] = 'Impreso';
$string['digitalized'] = 'Digitalizado';
$string['incorrection'] = 'En corrección';
$string['graded'] = 'Corregido';
...
$string['ganttprint'] = 'Impresión';
$string['ganttdigitization'] = 'Digitalización';
$string['ganttcorrection'] = 'Corrección';
$string['ganttpublication'] = 'Publicación';
$string['ganttrecorrection'] = 'Recorrección';
$string['total'] = 'total';
$string['searchcourses'] = 'Buscar cursos';
$string['search'] = 'Buscar';
$string['justice_perception'] = 'Percepción de Justicia';
$string['cicletabledays'] = 'Días(s)';
$string['cicletablehours'] = 'Horas(s)';
$string['ciclechartalert'] = 'Si algun estado no se muestra en el gráfico puede que este haya tomado menos de 24Horas, revise la primera tabla bajo el grafico para información mas especifica.';
$string['cicletable'] = 'Tabla resumen ciclo EMarking';
$string['ciclechart'] = 'Gráfico resumen ciclo EMarking';
$string['justiceperceptiontable'] = 'Tabla percepción de justicia';
$string['cicletablealert'] = 'Si existe una diferencia entre el tiempo total y la sumatoria de los estados recuerde que las horas no muestran minutos que pueden estar incluidos.';
$string['cicleganttchart'] = 'Carta gantt ciclo eMarking';
$string['ciclestackedstatuses'] = 'Ciclo de pruebas Emarking';
...
$string['choosevalue'] = 'Elija un valor';
$string['optionalcomment'] = 'Comentario opcional';
$string['updateevaluate'] = 'Las respuestas fueron actualizadas satisfactoriamente.';
$string['createevaluate'] = 'Las respuestas fueron guardadas satisfactoriamente.';
$string['formevaluatedfeedback'] = 'Formulario para la evaluación de la retroalimentación';
$string['value'] = 'Valor';
$string['indicator'] = 'Indicador';
$string['countofmarkers'] = 'Cantidad de correctores';
$string['timeincorrection'] = 'Tiempo total de corrección';
$string['timestudentview'] = 'Tiempo total de revisión del alumno';
$string['criteriontoevaluate'] = 'Criterios para evaluar la retroalimentación generada por el corrector';
$string['evaluation'] = 'Evaluación';
$string['complexitycriterion'] = 'Complejidad, es posible entender los mensajes entregados por el corrector.';
$string['relevantcriterion'] = 'El corrector provee información sobre el resultado esperado. Indica, explicita o indirectamente, la brecha entre el resultado esperado y lo contestado por el alumno.';
$string['personalizationcriterion'] = 'Los mensajes entregados por el corrector son personalizados, de modo, que su compresión es amigable.';
...
$string['roleidstudent'] = 'Rol id estudiantes.';
$string['roleidstudent_help'] = 'Rol Id que utilizará emarking para identificar a los estudiantes de los cursos.';