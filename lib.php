 ...
 *        	filter by only those that are enabled
 * @return string[]
 */
...
function mod_emarking_extend_navigation_category_settings(navigation_node $parentnode, context_coursecat $context) {
	if (has_capability ( 'mod/emarking:printordersview', $context )) {
		...
		$thingnode = $categorynode->add ( get_string ( 'printorders', 'mod_emarking' ), new moodle_url ( "/mod/emarking/print/printorders.php", array (
